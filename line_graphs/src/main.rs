...
fn do_hg() {
    ...
    let mut hg = HarmoniGraph::new().with_preset(3).with_scale(0.25);
...
fn do_lissajous() {
    ...
    let mut lj = Lissajous::new().with_preset(6).with_scale(0.3);
...
fn do_hg3d() {
    ...
    let mut hg3d = HarmoniGraph3D::new().with_preset(4).with_scale(0.25);
